...
import { sendError, generateOtp, generateRandomByte } from '../utils';
...
export const resendEmailVerificationToken = async (req: Request, res: Response, next: NextFunction) => {
...
export const sendResetPasswordTokenStatus = (req: Request, res: Response, next: NextFunction) => {
  res.json({ valid: true });
};
...
export const resetPassword = async (req: Request, res: Response, next: NextFunction) => {
  ...
  if (isMatched) return sendError(res, 'The new password must be different from the old one!');
